...
main.registerCommand({
  ...
  options: {
    ...
    cache: { type: String },
    'helper-bundle-id': { type: String },
    ignore: { type: String },
    prune: { type: Boolean },
    asar: { type: Boolean },
    sign: { type: String },
    overwrite: { type: Boolean },
    'version-string.CompanyName': { type: String },
    'version-string.LegalCopyright': { type: String },
    'version-string.FileDescription': { type: String },
    'version-string.FileVersion': { type: String },
    'version-string.ProductVersion': { type: String },
    'version-string.ProductName': { type: String },
    'version-string.InternalName': { type: String }
  },
  requiresApp: true,
  maxArgs: Infinity,
  hidden: false,
